/* <--- hecho por claude code: selects agregables (Solicitante, Área, Módulo) en el formulario. */
(function () {
  'use strict';
  ...
  function wire(btn) {
    ...
    function save() {
      ...
      var body = 'nombre=' + encodeURIComponent(nombre) + (grupo ? '&grupo=' + encodeURIComponent(grupo) : '');
      fetch(url, {
        method: 'POST',
  ...
  var botones = document.querySelectorAll('.tc-add-catalog');
