...
urlpatterns = [
    ...
    path('historial-alumnado/<str:area>/grado/', views.historial_alumnado_grado, name='historial_alumnado_grado'),
    ...
    path('telefonos-alumno/<str:alumno_id>/', views.telefonos_alumno, name='telefonos_alumno'),
    path('r/<str:token>/reporte.png', views.reporte_png, name='reporte_png'),  # <--- hecho por claude code: PNG del reporte (WhatsApp, público con token; termina en .png para la vista previa)
