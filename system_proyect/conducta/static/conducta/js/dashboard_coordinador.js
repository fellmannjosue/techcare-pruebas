...
const CFG_CONDUCTA_DASHBOARD_COORDINADOR = (function(){
...
window._PAGE = {
    ...
    isSuperuser:    CFG_CONDUCTA_DASHBOARD_COORDINADOR.j5,
    urlReenviar:    CFG_CONDUCTA_DASHBOARD_COORDINADOR.v1,
    urlSetCoord:    CFG_CONDUCTA_DASHBOARD_COORDINADOR.v2,
    urlEditarAjax:  CFG_CONDUCTA_DASHBOARD_COORDINADOR.v3,
    urlBulkDelete:  CFG_CONDUCTA_DASHBOARD_COORDINADOR.v4,
...
/* <--- hecho por claude code: bloques restaurados del refactor dde91be (se perdieron).
   Editar/guardar reporte inline (window._abrirEditar), reenviar, set coordinador,
   evidencia/lightbox y borrado masivo. Solo dependen de window._PAGE (definido arriba). */
(function () {
  'use strict';
