...
const CFG_LOGIN_BLOQUEO = (function(){
...
(function(){var s=CFG_LOGIN_BLOQUEO.j2;var el=document.getElementById('tempSecs');var b=document.querySelector('#loginForm button[type=submit]');if(b)b.disabled=true;var t=setInterval(function(){s--;if(el)el.textContent=s;if(s<=0){clearInterval(t);var w=document.getElementById('tempLock');if(w)w.remove();if(b)b.disabled=false;}},1000);})();
...
(function(){
              ...
              f.addEventListener('submit', function(e){
                ...
                btn.disabled=true;
                fetch(CFG_LOGIN_BLOQUEO.v0,{method:'POST',headers:{'Content-Type':'application/json'},
                  body:JSON.stringify({name:CFG_LOGIN_BLOQUEO.v1,grade:'Desbloqueo de acceso',email:email,
                    description:'Solicitud de desbloqueo de acceso — usuario: CFG_LOGIN_BLOQUEO.j1. '+msg})})
