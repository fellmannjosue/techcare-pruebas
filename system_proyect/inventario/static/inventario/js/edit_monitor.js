/* edit_monitor.js — uses window._MONITOR_PAGE set by the template bridge */
(function () {
    ...
    var EDIT_LABS_USADOS      = new Set(window._MONITOR_PAGE.labsUsados);
    var EDIT_ASIGNADOS_USADOS = new Set(window._MONITOR_PAGE.asignadosUsados);
