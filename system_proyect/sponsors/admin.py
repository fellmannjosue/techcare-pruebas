...
class DirectedAdmin(UnfoldModelAdmin):
    list_display = ('id', 'description')
    search_fields = ('description',)

@admin.register(Title)
class TitleAdmin(UnfoldModelAdmin):
    list_display = ('id', 'description')
    search_fields = ('description',)

@admin.register(Sponsor)
class SponsorAdmin(UnfoldModelAdmin):
...
class GodfatherAdmin(UnfoldModelAdmin):
...
class CorrespondenceAdmin(UnfoldModelAdmin):
