/* <--- hecho por claude code: config por data-* (#mh-config); antes tenía tags
   {% url %} DENTRO del .js, que Django NO procesa, así quedaban como texto literal
   y además faltaba toda la lógica de la tabla. */
(function(){
  var d = document.getElementById('mh-config');
  window._MH = {
    urlHistorial: d ? d.dataset.urlHistorial : '',
    urlPdf:       d ? d.dataset.urlPdf : '',
  };
})();
